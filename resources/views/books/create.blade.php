        ...
        <div class="col-md-8">
            ...
            <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <input type="text" class="form-control {{ $errors->first('title') ? 'is-invalid' : '' }}"
                    value="{{ old('title') }}" name="title" placeholder="Book title">
                ...
                <textarea name="description" id="description"
                    class="form-control {{ $errors->first('desciption') ? 'is-invalid' : '' }}"
                ...
                <input type="number" value="{{ old('stock') }}"
                    class="form-control {{ $errors->first('stock') ? 'is-invalid' : '' }}" id="stock" name="stock"
                    min=0 value=0>
                <div class="invalid-feedback">
                    {{ $errors->first('stock') }}
                </div>
